...
class CvPediaCivilization:
	...
	def placeTech(self):
		screen = self.top.getScreen()
		panelName = self.top.getNextWidgetName()
		screen.addPanel( panelName, CyTranslator().getText("Special Features", ()), "", False, True, self.X_TECH, self.Y_UNIT, self.W_BUILDING, self.H_UNIT, PanelStyles.PANEL_STYLE_BLUE50 )
	...
	def placeUnit(self):
		screen = self.top.getScreen()
		panelName = self.top.getNextWidgetName()
		screen.addPanel( panelName, CyTranslator().getText("Unique Units", ()), "", False, True, self.X_BUILDING, self.Y_UNIT, self.W_BUILDING, self.H_UNIT, PanelStyles.PANEL_STYLE_BLUE50 )
