...
//Influence Driven War: Added for PIG Mod by PieceOfMind 26/10/09
		...
		.value("GAMEOPTION_IDW_NO_BARBARIAN", GAMEOPTION_IDW_NO_BARBARIAN)
...
//doto 115 happyness golden age
		.value("GAMEOPTION_HAPPYNESS_GOLDEN_AGE", GAMEOPTION_HAPPYNESS_GOLDEN_AGE)
//
    // doto options keldath
		.value("GAMEOPTION_CULTURE_WONDER_LIMIT", GAMEOPTION_CULTURE_WONDER_LIMIT)
		.value("GAMEOPTION_CULTURE_WONDER_LIMIT_OBSOLETE", GAMEOPTION_CULTURE_WONDER_LIMIT_OBSOLETE)
		.value("GAMEOPTION_PALACE_UPGRADE", GAMEOPTION_PALACE_UPGRADE)
        .value("GAMEOPTION_IMPROVEMENT_DECAY", GAMEOPTION_IMPROVEMENT_DECAY)
        .value("GAMEOPTION_IMPROVEMENT_OBSOLETE", GAMEOPTION_IMPROVEMENT_OBSOLETE)
        .value("GAMEOPTION_NO_CORPORATIONS", GAMEOPTION_NO_CORPORATIONS)
		.value("GAMEOPTION_LIMITED_RELIGION", GAMEOPTION_LIMITED_RELIGION)
		.value("GAMEOPTION_FORBIDDEN_RELIGION", GAMEOPTION_FORBIDDEN_RELIGION)
		.value("GAMEOPTION_BARBARIAN_CIV", GAMEOPTION_BARBARIAN_CIV)
		.value("GAMEOPTION_POPULATION_LIMIT", GAMEOPTION_POPULATION_LIMIT)
		.value("GAMEOPTION_LEFT_FROM_BEHIND", GAMEOPTION_LEFT_FROM_BEHIND)
