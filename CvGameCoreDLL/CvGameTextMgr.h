...
public:
	...
	//doto governor cloned function parseSpecialistHelp
	void parseGovernorpecialistHelp(CvWStringBuffer &szHelpString, SpecialistTypes eSpecialist, CvCity* pCity, bool bCivilopediaText = false);
	//doto governor
