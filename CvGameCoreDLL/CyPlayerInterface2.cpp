...
//doto 115 happiness golden age
//doto 115 civic dependecy goverment screen
		.def("getGovermentConversionCounter", &CyPlayer::getGovermentConversionCounter, "int (int eCivic)")
		.def("getCivicParent", &CyPlayer::getCivicParent, "CivicTypes (int eCivic)")
