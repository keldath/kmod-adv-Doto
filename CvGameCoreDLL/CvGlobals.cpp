...
m_iSKIP_RANGE_ATTACK_MIN_BEST_ATTACK_ODDS(0),
m_iSKIP_RANGE_ATTACK_MIN_STACK_RATIO(0),
m_iRANGESTRIKE_HIT_MODIFIER(0),
m_iRANGESTRIKE_DICE(0),
m_iRANGE_COMBAT_DAMAGE(0),
m_iRANGESTRIKE_ATT_MOD(0),
m_iIDW_EMERGENCY_DRAFT_ENABLED(0),	
m_iIDW_EMERGENCY_DRAFT_MIN_POPULATION(0),	
m_fIDW_FORT_CAPTURE_MULTIPLIER(0),	
m_fIDW_BASE_COMBAT_INFLUENCE(0),	
m_fIDW_EXPERIENCE_FACTOR(0),	
m_iIDW_INFLUENCE_RADIUS(0),	
m_fIDW_PLOT_DISTANCE_FACTOR(0),	
m_iIDW_NO_BARBARIAN_INFLUENCE(0),	
m_iIDW_NO_NAVAL_INFLUENCE(0),	
m_fIDW_BASE_PILLAGE_INFLUENCE(0),	
m_fIDW_WINNER_PLOT_MULTIPLIER(0),	
m_fIDW_LOSER_PLOT_MULTIPLIER(0),	
m_fIDW_WARLORD_MULTIPLIER(0),	
m_fIDW_EMERGENCY_DRAFT_ANGER_MULTIPLIER(0),	
m_fIDW_EMERGENCY_DRAFT_STRENGTH(0),	
// MOD - END - Ranged Strike AI
//capital alternative building
m_cCAPITAL_BUILDINGCLASS_2(NULL),
m_cCAPITAL_BUILDINGCLASS_3(NULL),
m_iBASE_LOSS_CAPITAL_ANARCHY_LENGTH(0),
m_iCULTURE_CONTROL_IMPROVEMENT_CULTURE_BORDER_SQUARE(0),
m_iCULTURE_CONTROL_IMPROVEMENT_ALWAYS_KEEP_OWNER_BORDER(0),
m_iPEAK_EXTRA_DEFENSE(0),	
m_iPEAK_EXTRA_MOVEMENT(0),	
m_iPEAK_CAN_FOUND_CITY(0),	
m_iPEAK_BUILD_TIME_MODIFIER(0),	
m_iCULTURE_GOLDEN_AGE_THRESHOLD(0),
//doto 115 happyness golden age
m_iHAPPYNESS_GOLDEN_AGE_THRESHOLD(0),
m_iTRUNCATE_ANIMATIONS(0),	
m_iTRUNCATE_ANIMATIONS_ERA(0),	
m_iTRUNCATE_ANIMATION_TURNS(0),
m_iSPECIALISTS_INSTEAD_OF_POPULATION(0),	
m_iENHANCED_CITY_STATES_THRESHOLD(0),	
m_iFREE_UNITS_PER_STATE_MOD(0),	
m_iCITY_STATE_TECH_DIFFUSION_MOD(0),	
m_iCS_BUILD_UNITS_WITH_NO_PREQ_BONUS(0),	
m_iCS_START_SIGHT_RANGE(0),	
m_iCS_CULTURE_LEVEL_MIN_RADIOUS(0),	
m_iCS_CULTURE_LEVEL_MAX_RADIOUS(0),	
m_iDISPLAY_CITY_STATES_IN_CUSTOM_GAME(0),	
m_iSET_NUMBER_OF_CITY_STATES_SPAWN_TINY(0),	
m_iSET_NUMBER_OF_CITY_STATES_SPAWN_SMALL(0),	
m_iSET_NUMBER_OF_CITY_STATES_SPAWN_STANDARD(0),	
m_iSET_NUMBER_OF_CITY_STATES_SPAWN_LARGE(0),	
m_iSET_NUMBER_OF_CITY_STATES_SPAWN_HUGE(0),	
/*
m_iCIVILIAN_THRESH_1(0),	
m_iCIVILIAN_THRESH_2(0),	
m_iCIVILIAN_THRESH_3(0),	
m_iCIVILIAN_THRESH_4(0),	
m_iCIVILIAN_THRESH_5(0),	
m_iCIVILIAN_LIMIT_1(0),	
m_iCIVILIAN_LIMIT_2(0),	
m_iCIVILIAN_LIMIT_3(0),	
m_iCIVILIAN_LIMIT_4(0),	
m_iCIVILIAN_LIMIT_5(0),	
*/
/*************************************************************************************************/
...
//MOD@VET_Andera412_Blocade_Unit-end1/2
/* MOD - START - Ranged Strike AI*/	
		case SKIP_RANGE_ATTACK_MIN_BEST_ATTACK_ODDS	: iDefault = 80; break;
		case SKIP_RANGE_ATTACK_MIN_STACK_RATIO	: iDefault = 150; break;
		case RANGESTRIKE_HIT_MODIFIER	: iDefault = 2; break;
		case RANGESTRIKE_DICE	: iDefault = 100; break;
		case RANGE_COMBAT_DAMAGE	: iDefault = 30; break;
		case RANGESTRIKE_ATT_MOD	: iDefault = 15; break;
/* MOD - END - Ranged Strike AI*/		
/* MOD - START - INFLUENCE DRIVEN WAR CACHE*/		
		case IDW_EMERGENCY_DRAFT_ENABLED	: iDefault = 0; break;
		case IDW_INFLUENCE_RADIUS	: iDefault = 2; break;
		case IDW_NO_BARBARIAN_INFLUENCE	: iDefault = 0; break;
		case IDW_NO_NAVAL_INFLUENCE	: iDefault = 0; break;
...
// MOD - START - Ranged Strike AI
	m_iSKIP_RANGE_ATTACK_MIN_BEST_ATTACK_ODDS = getDefineINT("SKIP_RANGE_ATTACK_MIN_BEST_ATTACK_ODDS");
	m_iSKIP_RANGE_ATTACK_MIN_STACK_RATIO = getDefineINT("SKIP_RANGE_ATTACK_MIN_STACK_RATIO");
	m_iRANGESTRIKE_HIT_MODIFIER = getDefineINT("RANGESTRIKE_HIT_MODIFIER");
	m_iRANGESTRIKE_DICE = getDefineINT("RANGESTRIKE_DICE");
	m_iRANGE_COMBAT_DAMAGE = getDefineINT("RANGE_COMBAT_DAMAGE");
	m_iRANGESTRIKE_ATT_MOD = getDefineINT("RANGESTRIKE_ATT_MOD");
/* MOD - END - Ranged Strike AI*/
/* MOD - START - INFLUENCE DRIVEN WAR CACHE*/	
...
/* MOD - END - INFLUENCE DRIVEN WAR CACHE*/
	m_cCAPITAL_BUILDINGCLASS_2 = getDefineSTRING("CAPITAL_BUILDINGCLASS_2");
	m_cCAPITAL_BUILDINGCLASS_3 = getDefineSTRING("CAPITAL_BUILDINGCLASS_3");
	m_iBASE_LOSS_CAPITAL_ANARCHY_LENGTH	= getDefineINT("BASE_LOSS_CAPITAL_ANARCHY_LENGTH");
	m_iCULTURE_CONTROL_IMPROVEMENT_CULTURE_BORDER_SQUARE	= getDefineINT("CULTURE_CONTROL_IMPROVEMENT_CULTURE_BORDER_SQUARE");
	m_iCULTURE_CONTROL_IMPROVEMENT_ALWAYS_KEEP_OWNER_BORDER	= getDefineINT("CULTURE_CONTROL_IMPROVEMENT_ALWAYS_KEEP_OWNER_BORDER");
	m_iPEAK_EXTRA_DEFENSE	= getDefineINT("PEAK_EXTRA_DEFENSE");
	m_iPEAK_EXTRA_MOVEMENT	= getDefineINT("PEAK_EXTRA_MOVEMENT");
	m_iPEAK_CAN_FOUND_CITY	= getDefineINT("PEAK_CAN_FOUND_CITY");
	m_iPEAK_BUILD_TIME_MODIFIER	= getDefineINT("PEAK_BUILD_TIME_MODIFIER");
	m_iCULTURE_GOLDEN_AGE_THRESHOLD	= getDefineINT("CULTURE_GOLDEN_AGE_THRESHOLD");
//DOTO 114 happyness golden age
	m_iHAPPYNESS_GOLDEN_AGE_THRESHOLD = getDefineINT("HAPPYNESS_GOLDEN_AGE_THRESHOLD");
	m_iTRUNCATE_ANIMATIONS	= getDefineINT("TRUNCATE_ANIMATIONS");
	m_iTRUNCATE_ANIMATIONS_ERA	= getDefineINT("TRUNCATE_ANIMATIONS_ERA");
	m_iTRUNCATE_ANIMATION_TURNS	= getDefineINT("TRUNCATE_ANIMATION_TURNS");
	m_iSPECIALISTS_INSTEAD_OF_POPULATION	= getDefineINT("SPECIALISTS_INSTEAD_OF_POPULATION");	
	m_iENHANCED_CITY_STATES_THRESHOLD = getDefineINT("ENHANCED_CITY_STATES_THRESHOLD");	
	m_iFREE_UNITS_PER_STATE_MOD	= getDefineINT("FREE_UNITS_PER_STATE_MOD");	
	m_iCITY_STATE_TECH_DIFFUSION_MOD	= getDefineINT("CITY_STATE_TECH_DIFFUSION_MOD");	
	m_iCS_BUILD_UNITS_WITH_NO_PREQ_BONUS	= getDefineINT("CS_BUILD_UNITS_WITH_NO_PREQ_BONUS");	
	m_iCS_START_SIGHT_RANGE	= getDefineINT("CS_START_SIGHT_RANGE");	
	m_iCS_CULTURE_LEVEL_MIN_RADIOUS	= getDefineINT("CS_CULTURE_LEVEL_MIN_RADIOUS");	
	m_iCS_CULTURE_LEVEL_MAX_RADIOUS	= getDefineINT("CS_CULTURE_LEVEL_MAX_RADIOUS");	
	m_iDISPLAY_CITY_STATES_IN_CUSTOM_GAME	= getDefineINT("DISPLAY_CITY_STATES_IN_CUSTOM_GAME");	
	m_iSET_NUMBER_OF_CITY_STATES_SPAWN_TINY	= getDefineINT("SET_NUMBER_OF_CITY_STATES_SPAWN_TINY");	
	m_iSET_NUMBER_OF_CITY_STATES_SPAWN_SMALL	= getDefineINT("SET_NUMBER_OF_CITY_STATES_SPAWN_SMALL");	
	m_iSET_NUMBER_OF_CITY_STATES_SPAWN_STANDARD	= getDefineINT("SET_NUMBER_OF_CITY_STATES_SPAWN_STANDARD");	
	m_iSET_NUMBER_OF_CITY_STATES_SPAWN_LARGE	= getDefineINT("SET_NUMBER_OF_CITY_STATES_SPAWN_LARGE");	
	m_iSET_NUMBER_OF_CITY_STATES_SPAWN_HUGE	= getDefineINT("SET_NUMBER_OF_CITY_STATES_SPAWN_HUGE");	
/*
	m_iCIVILIAN_THRESH_1	= getDefineINT("CIVILIAN_THRESH_1");	
	m_iCIVILIAN_THRESH_2	= getDefineINT("CIVILIAN_THRESH_2");	
	m_iCIVILIAN_THRESH_3	= getDefineINT("CIVILIAN_THRESH_3");	
	m_iCIVILIAN_THRESH_4	= getDefineINT("CIVILIAN_THRESH_4");	
	m_iCIVILIAN_THRESH_5	= getDefineINT("CIVILIAN_THRESH_5");	
	m_iCIVILIAN_LIMIT_1	= getDefineINT("CIVILIAN_LIMIT_1");	
	m_iCIVILIAN_LIMIT_2	= getDefineINT("CIVILIAN_LIMIT_2");	
	m_iCIVILIAN_LIMIT_3	= getDefineINT("CIVILIAN_LIMIT_3");	
	m_iCIVILIAN_LIMIT_4	= getDefineINT("CIVILIAN_LIMIT_4");	
	m_iCIVILIAN_LIMIT_5	= getDefineINT("CIVILIAN_LIMIT_5");	
*/
/************************
/*************************************************************************************************/
/** TGA_INDEXATION                          11/13/07                            MRGENIE          */
