...
//Mountains Mod nm
	bool isCanMovePeak() const; //Deliverator	
...
//===NM=====Mountains Mod===0=====
	//keldath no need for dllexport
	//DllExport bool isPeakMakesValid() const;				// Exposed to Python
	bool isPeakMakesValid() const;				// Exposed to Python
//===NM=====Mountains Mod===X=====
// davidlallen: mountain limitations next line
	DllExport bool isPeakMakesInvalid() const;
...
//===NM=====Mountains Mod===0=====
/*	DllExport removed by keldath*/						// Exposed to Python
