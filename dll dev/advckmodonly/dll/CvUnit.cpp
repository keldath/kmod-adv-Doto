...
/*************************************************************************************************/
				...
				*/
				// New code
				if (GC.getGameINLINE().isOption(GAMEOPTION_INFLUENCE_DRIVEN_WAR) && GC.getDefineINT("IDW_PILLAGE_INFLUENCE_ENABLED"))
				//End PIG Mod
				{
...
/*************************************************************************************************/
		...
		// < JCultureControl Mod Start >
		if (pPlot->getImprovementType() != NO_IMPROVEMENT)//this check wasnt in my merge to advc - why?
		{
		pPlot->setImprovementType((ImprovementTypes)(GC.getImprovementInfo(pPlot->getImprovementType()).getImprovementPillage()));
        // < JCultureControl Mod Start >
	 	}
...
bool CvUnit::build(BuildTypes eBuild)
{
	...
	if (bFinished)
	{
	    ...
	    {
	        if (GC.getImprovementInfo((ImprovementTypes) GC.getBuildInfo(eBuild).getImprovement()).isSpreadCultureControl()  && GC.getGameINLINE().isOption(GAMEOPTION_CULTURE_CONTROL))
	        {
...
//DOTO-mointains mod --need to make it separate?
...
{
	if (GC.getGameINLINE().isOption(GAMEOPTION_INFLUENCE_DRIVEN_WAR) && GC.getGame().isOption(GAMEOPTION_IDW_NO_BARBARIAN))
	{
	...
	if (GC.getGameINLINE().isOption(GAMEOPTION_INFLUENCE_DRIVEN_WAR) && GC.getGame().isOption(GAMEOPTION_IDW_NO_NAVAL))
	{
