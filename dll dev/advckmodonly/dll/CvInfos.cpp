...
//mountains mod
	pXML->GetChildXmlValByName(&m_bCanMovePeak, "bCanMovePeak"); //Deliverator	
...
bool CvImprovementInfo::read(CvXMLLoadUtility* pXML)
{
    ...
    // < JImprovementLimit Mod Start >
	pXML->GetChildXmlValByName(&m_bNotInsideBorders, "bNotInsideBorders");
	pXML->GetChildXmlValByName(&m_iMakesInvalidRange, "iMakesInvalidRange");
	// < JImprovementLimit Mod End >
