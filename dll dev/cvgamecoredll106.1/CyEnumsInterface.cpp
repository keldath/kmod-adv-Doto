...
//rangedattack-keldath
		...
		.value("GAMEOPTION_RANGED_END_MOVES", GAMEOPTION_RANGED_END_MOVES)
...
//		.value("GAMEOPTION_RANGED_LAND_COST_MOVES", GAMEOPTION_RANGED_LAND_END_MOVES)
		.value("GAMEOPTION_RAND_BOMB_DMG", GAMEOPTION_RAND_BOMB_DMG)
//		.value("GAMEOPTION_RAND_AIR_BOMB_DMG", GAMEOPTION_RAND_AIR_BOMB_DMG)
//		.value("GAMEOPTION_RAND_BOMBARD_DMG", GAMEOPTION_RAND_BOMBARD_DMG)
//		.value("GAMEOPTION_RAND_RANGED_DMG", GAMEOPTION_RAND_RANGED_DMG)
