...
/*** RANGED BOMBARDMENT - Dale START ***/
		.value("INTERFACEMODE_RANGEBOMB", INTERFACEMODE_RANGEBOMB)
...
//rangedattack-keldath
		...
		.value("GAMEOPTION_RAND_BOMB_HIT", GAMEOPTION_RAND_BOMB_HIT)
		.value("GAMEOPTION_RAND_RANGEDSTRIKE_DMG", GAMEOPTION_RAND_RANGEDSTRIKE_DMG)
