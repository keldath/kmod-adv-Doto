...
//
    // bt keldath
		...
		.value("GAMEOPTION_RANGED_LAND_INDIRECT_ATTACK", GAMEOPTION_RANGED_LAND_INDIRECT_ATTACK)
		.value("GAMEOPTION_RANGED_SEA_INDIRECT_ATTACK", GAMEOPTION_RANGED_SEA_INDIRECT_ATTACK)
		;
