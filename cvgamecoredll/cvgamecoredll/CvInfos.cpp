...
// ++++++++++++++++++++++++++++++++++NOTE TO SDK MODDERS++++++++++++++++++++++++++++++++++++++
//
// The following code block should be uncommented and inserted into the copyNonDefaults function 
// necessary for modular XML loading, should your SDK mod include this.
// The following block should reside after the NUM_COMMERCE_TYPES for loop and before the
// if (getExperience() == iDefault) m_iExperience = pClassInfo->getExperience();   line.
// Vanilla BtS DOES NOT require this block of code to function correctly.
// PM me if you have any questions about this.
/*************************************************************************************************/
/** Specialists Enhancements, by Supercheese 10/9/09                                                   */
/**                                                                                              */
/**       i dont know why this is commented out - f1rpo if you see this can you comment?                                                                                       */
/*************************************************************************************************/
...
{	/*  advc.006b: Explicit default values (0) set for most TechInfo tags
		re added by keldath to advc 096
		in order to make them optional */
	CvString szTextVal;
	if (!CvInfoBase::read(pXML))
	{
		return false;
...
//added by keldath back - secondary value
...
// Deliverator peaks 
bool CvUnitInfo::isCanMovePeak() const
{
	return m_bCanMovePeak;
}
// Deliverator
...
/*************************************************************************************************/
	...
	pXML->GetChildXmlValByName(&m_iExtraHappiness, "iExtraHappiness", /* advc.006b: */ 0); // K-Mod
...
bool CvImprovementInfo::read(CvXMLLoadUtility* pXML)
{
	...
	// < JCultureControl Mod End >
// Deliverator fresh water
	pXML->GetChildXmlValByName(&m_iAddsFreshWaterInRadius, "iAddsFreshWaterInRadius");	
	// Deliverator
...
bool CvImprovementInfo::readPass2(CvXMLLoadUtility* pXML)
{
    ...
    // < JImprovementLimit Mod Start >
	pXML->GetChildXmlValByName(szTextVal, "ImprovementRequired");
...
bool CvFeatureInfo::read(CvXMLLoadUtility* pXML)
{
	...
	pXML->GetChildXmlValByName(&m_iDefenseModifier, "iDefense");
	// advc.012: added secondary value keldath
