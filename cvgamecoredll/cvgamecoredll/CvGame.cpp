...
//pasted here from cvplayer - suggested by f1 advc - keldath
	...
	{
		if (!(isOption((GameOptionTypes)GC.getBuildingInfo(eBuilding).getPrereqGameOption())))
	...
	{
		if (isOption((GameOptionTypes)GC.getBuildingInfo(eBuilding).getNotGameOption()))
		// changed - suggested by f1
...
/*removed by forbidden religion - i think - keldath
...
*/
					...
					{
						//changed by forbidden religion - i think - keldath
